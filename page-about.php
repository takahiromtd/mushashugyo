...
<h2 class="text-center text-danger font-weight-bold">新興国での超実践型海外ビジネス研修</h2>
<div class="row">
<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">

<p>弊社がベトナムで運営する店舗にて、全国から集まる大学生がチームを組み、新規ビジネス担当者として、新商品・サービス開発やプロモーション企画を自分で考え、自分で行動し、カタチにし、顧客に届ける。リアルなビジネス体験学習プログラムです。</p>

<p>新興国ならではの予期せぬ事態やチーム内でのコンフリクトなど、様々な困難に直面する中自分自身の成長課題に向き合い、自己変革（変態）していく。成果を出すために、自己変革や、全力を出すことを経験し主体的に状況や人生を切り拓く力”自走式エンジン®”を積む。それがプログラムのゴールです。</p>

</div>
</div>
<div class="embed-responsive embed-responsive-16by9 mt-5 mb-5">
<iframe class="embed-responsive-item" src="https://www.youtube.com/embed/MGEfDd2G-5o"></iframe></div>
</section>
<section class="mw960 mx-auto d-block">
...
<tr>
<td class="text-center" rowspan="5">ベトナム
15日</td>
